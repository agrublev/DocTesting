...
[![Build Status](https://travis-ci.org/agrublev/DocTesting.svg?branch=master)](https://travis-ci.org/agrublev/DocTesting)
...
6. If you did everything correct, https://agrublev.github.io/DocTesting/ will lead to your new docs
...
- Documentation(ReDoc): https://agrublev.github.io/DocTesting/
- SwaggerUI: https://agrublev.github.io/DocTesting/swagger-ui/
- Look full spec:
    + JSON https://agrublev.github.io/DocTesting/swagger.json
    + YAML https://agrublev.github.io/DocTesting/swagger.yaml
- Preview spec version for branch `[branch]`: https://agrublev.github.io/DocTesting/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://agrublev.github.io/DocTesting/ with url from the message: `Server started <url>`
